...
### Trust and Enable Dependencies

If you encounter an issue with `LiveViewNativeMacros` or any other dependencies, select `Trust & Enable` to resolve the problem. You may need to click on the error in the Xcode error console to see the prompt.
